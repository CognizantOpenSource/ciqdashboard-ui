...
@Component({
  selector: 'app-chart-fusion-funnel',
  templateUrl: './chart-fusion-funnel.component.html',
  styleUrls: ['./chart-fusion-funnel.component.scss']
})
export class ChartFusionFunnelComponent extends BaseChart implements OnInit {
