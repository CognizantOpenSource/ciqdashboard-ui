...
@Component({
  selector: 'app-chart-fusion-bar2d',
  templateUrl: './chart-fusion-bar2d.component.html',
  styleUrls: ['./chart-fusion-bar2d.component.scss']
})
export class ChartFusionBar2dComponent extends BaseChart implements OnInit {
