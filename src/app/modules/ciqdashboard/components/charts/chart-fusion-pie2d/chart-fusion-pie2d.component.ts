...
@Component({
  selector: 'app-chart-fusion-pie2d',
  templateUrl: './chart-fusion-pie2d.component.html',
  styleUrls: ['./chart-fusion-pie2d.component.scss']
})
export class ChartFusionPie2dComponent extends BaseChart implements OnInit {
