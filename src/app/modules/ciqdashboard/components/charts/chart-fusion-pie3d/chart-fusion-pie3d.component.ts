...
@Component({
  selector: 'app-chart-fusion-pie3d',
  templateUrl: './chart-fusion-pie3d.component.html',
  styleUrls: ['./chart-fusion-pie3d.component.scss']
})
export class ChartFusionPie3dComponent extends BaseChart implements OnInit {
