...
@Component({
  selector: 'app-chart-fusion-doughnut2d',
  templateUrl: './chart-fusion-doughnut2d.component.html',
  styleUrls: ['./chart-fusion-doughnut2d.component.scss']
})
export class ChartFusionDoughnut2dComponent extends BaseChart implements OnInit {
