...
@Component({
  selector: 'app-chart-fusion-area2d',
  templateUrl: './chart-fusion-area2d.component.html',
  styleUrls: ['./chart-fusion-area2d.component.scss']
})
export class ChartFusionArea2dComponent extends BaseChart implements OnInit {
