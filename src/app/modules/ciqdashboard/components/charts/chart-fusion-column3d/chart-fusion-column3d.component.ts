...
@Component({
  selector: 'app-chart-fusion-column3d',
  templateUrl: './chart-fusion-column3d.component.html',
  styleUrls: ['./chart-fusion-column3d.component.scss']
})
export class ChartFusionColumn3dComponent extends BaseChart implements OnInit {
