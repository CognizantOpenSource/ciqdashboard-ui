...
@Component({
  selector: 'app-chart-fusion-bar3d',
  templateUrl: './chart-fusion-bar3d.component.html',
  styleUrls: ['./chart-fusion-bar3d.component.scss']
})
export class ChartFusionBar3dComponent extends BaseChart implements OnInit {
