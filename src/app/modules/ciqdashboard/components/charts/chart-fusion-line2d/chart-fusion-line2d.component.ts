...
@Component({
  selector: 'app-chart-fusion-line2d',
  templateUrl: './chart-fusion-line2d.component.html',
  styleUrls: ['./chart-fusion-line2d.component.scss']
})
export class ChartFusionLine2dComponent extends BaseChart implements OnInit {
