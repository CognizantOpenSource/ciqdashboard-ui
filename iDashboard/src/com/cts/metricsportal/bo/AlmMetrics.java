...
public class AlmMetrics implements ITMMetrics {
	...
	/**
	 * This Service will return the total requirement details. Total Requirement
	 * - Date Filter
	 * 
	 * @param dashboardName
	 * @param domainName
	...
	public long getRequirementCountFilter(String authString, String dashboardName, String domainName,
		...
		if (operationalAccess) {
			totalreq = AlmMongoOperations.getRequirementCountFilter(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
		}
		return totalreq;
	...
	public List<ReqTrendVO> getRequirementTrendChart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
		...
		if (operationalAccess) {
			List<RequirementStatusVO> result = AlmMongoOperations.getRequirementTrendChart(startDate, endDate, dates,
			...
			for (int i = 0; i < result.size(); i++) {
				...
				result1 = AlmMongoOperations.getRequirementTrendChartFinal(startDate, endDate, dates, dateBefore7Days,
						levelIdList, info);
				...
				try {
					for (int j = 0; j < result1.size(); j++) {
						...
						else if (result1.get(j).getStatus().equalsIgnoreCase(IdashboardConstantsUtil.OBSOLETE)) {
							iobsolete = result1.get(j).getStatusCnt();
							reqtrendvo.setObsolete(iobsolete);
						}
				...
				for (ReqTrendVO chartVO : trendvolist) {
					...
					if (strDate.equals((format))) {
						...
						chartVO.setNotapplicable(iNotApplicable + chartVO.getNotapplicable());
						chartVO.setNorun(iNoRun + chartVO.getNorun());
						chartVO.setNotcompleted(iNotCompleted + chartVO.getNotcompleted());
						chartVO.setNotcovered(iNotCovered + chartVO.getNotcovered());
						chartVO.setPassed(iPassed + chartVO.getPassed());
						chartVO.setNostatus(iNoStatus + chartVO.getNostatus());
						chartVO.setObsolete(iobsolete + chartVO.getObsolete());
	 ...
	 * @throws ParseException
	 */
	public List<RequirementStatusVO> getRequirementBarChart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
		if (operationalAccess) {
			dailyStatus = AlmMongoOperations.getRequirementBarChart(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
	 ...
	 * @throws ParseException
	 */
	public List<RequirementStatusVO> getRequirementPriorityChartFilter(String authString, String dashboardName,
			String domainName, String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		if (operationalAccess) {
			priorityresult = AlmMongoOperations.getRequirementPriorityChartFilter(startDate, endDate, dates,
					dateBefore7Days, levelIdList);
		}
		return priorityresult;
	}

	public List<RequirmentVO> getRequirementRecords(String authString, int itemsPerPage, int startIndex,
		...
		List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
		if (operationalAccess) {
			reqAnalysisList = AlmMongoOperations.getRequirementRecords(startDate, endDate, dates, dateBefore7Days,
					levelIdList, itemsPerPage, startIndex);
		}
	...
	public long getRequirementVolatilityFilter(String authString, String dashboardName, String domainName,
		...
		if (operationalAccess) {
			reqResult = AlmMongoOperations.getRequirementVolatilityFilter(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
		}
	...
	public long getRequirementLeakFilter(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			reqLeak = AlmMongoOperations.getRequirementLeakFilter(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
		}
		return reqLeak;
	}

	public List<RequirmentVO> getRequirementRecordsAnalyseLevel(String authString, String dashboardName,
			String domainName, String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		reqAnalyzedataLevel = AlmMongoOperations.getRequirementRecordsAnalyseLevel(startDate, endDate, dates,
				dateBefore7Days, levelIdList);
	...
	public long getSearchPageCount(String authString, String releaseName, String reqID, String reqName, String description, String reqType,
			String status, String priority, String dashboardName, String domainName, String projectName,
			String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		long pageCount = 0;
...
//				projectName);
		...
		if (operationalAccess) {
			pageCount = AlmMongoOperations.getSearchPageCount(releaseName, reqID, reqName, description, reqType, status, priority,
	...
	public List<RequirmentVO> getRequirementSearchReq(String authString, String releaseName,String reqID, String reqName,
			String description, String reqType, String status, String priority, int itemsPerPage, int startIndex,
			String dashboardName, String domainName, String projectName, String vardtfrom, String vardtto,
			String timeperiod) throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
...
//				projectName);
		...
		if (operationalAccess) {
			searchResult = AlmMongoOperations.getRequirementSearchReq(reqID, itemsPerPage, startIndex, startDate,
					endDate, dates, dateBefore7Days, levelIdList, searchvalues);
		}
		return searchResult;
	}

	public List<RequirmentVO> getRecords(String authString, String sortvalue, int itemsPerPage, int startIndex,
			boolean reverse, String dashboardName, String domainName, String projectName, String vardtfrom,
		...
		List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdRequirement(dashboardName, userId, domainName,
				projectName);
		if (operationalAccess) {
			reqAnalyzedata = AlmMongoOperations.getRecords(sortvalue, reverse, itemsPerPage, startIndex, startDate,
					endDate, dates, dateBefore7Days, levelIdList);
		}
	 ...
	 * 
	 * @see
	 * com.cts.metricsportal.bo.ITMMetrics#getTotalDefectCountFilter(java.lang.
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				testCount = AlmMongoOperations.getTotalTestCountFilterQuery(dashboardName, userId, domainName,
	...
	public long getDesignCoverageFilter(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			try {
				List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);
				designcovg = AlmMongoOperations.getDesignCoverageFilterQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dates, dateBefore7Days, levelIdList);
	...
	public long getAutoCoverageFilter(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			try {
				List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);
				acresult = AlmMongoOperations.getAutoCoverageFilterQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dates, dateBefore7Days, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				executionAnalyzedataLevel = AlmMongoOperations.getRecordsLevelQuery(dashboardName, userId, domainName,
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				trendvolist = AlmMongoOperations.getTestCaseTrendchartQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dates, dateBefore7Days, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getdesignstatusQuery(dashboardName, userId, domainName, projectName,
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getdesigntypeQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getdesignownerQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
	...
	public long getDesignCoverage(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			try {
				List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);
				designcovg = AlmMongoOperations.getDesignCoverageQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dates, dateBefore7Days, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
	...
	public long getAutoCoverageinitial(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			try {
				List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDesign(dashboardName, userId, domainName,
						projectName);
				acresult = AlmMongoOperations.getAutoCoverageinitialQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dates, dateBefore7Days, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
	...
	public long getuniqueTcCount(String authString, String dashboardName, String domainName, String projectName,
			String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		if (operationalAccess) {
			totaluniqueTcExeCount = AlmMongoOperations.getuniqueTcCount(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
		}
	...
	public long getManualCount(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			totalmanualCount = AlmMongoOperations.getManualCount(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
		}
	...
	public long getTcCoverage(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			...
			long tcsplannedtoexecute = AlmMongoOperations.getTcPlan(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
	...
	public long firstTimePass(String authString, String dashboardName, String domainName, String projectName,
			String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		long reqResult = 0;
	...
	public long errorDiscovery1(String authString, String dashboardName, String domainName, String projectName,
			String vardtfrom, String vardtto, String timeperiod)
			throws BadLocationException, ParseException, JsonParseException {
		long reqResult = 0;
	...
	public List<TestExeStatusVO> getTcExeStatusbarchart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
	...
	public List<TCExecutionOwnerVO> getTcExeOwnerChart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
	...
	public List<TestExeTrendVO> getTestExecutionTrendchart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonMappingException, BadLocationException, ParseException {
...
*/
		...
		if (operationalAccess) {
			List<TestExeStatusVO> result = AlmMongoOperations.getTestExecutionTrendchart(startDate, endDate, dates,
					dateBefore7Days, levelIdList);
			...
			for (int i = 0; i < result.size(); i++) {
				...
				List<TestExeStatusVO> result1 = AlmMongoOperations.getTestExecutionTrendchartFinal(levelIdList,
						dateString);
	...
	public List<TestExecutionVO> getExecRecords(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		if (operationalAccess) {
			executionAnalyzedata = AlmMongoOperations.getExecRecords(startDate, endDate, dates, dateBefore7Days,
					levelIdList);
	...
	public List<TestExecutionVO> getExecutionRecords(String authString, String sortvalue, int itemsPerPage,
			int startIndex, boolean reverse, String dashboardName, String domainName, String projectName,
			String vardtfrom, String vardtto, String timeperiod)
			throws JsonParseException, JsonMappingException, BadLocationException, ParseException {
		...
		if (operationalAccess) {
			tcexeAnalyzedata = AlmMongoOperations.getExecutionRecords(sortvalue, itemsPerPage, startIndex, reverse,
					startDate, endDate, dates, dateBefore7Days, levelIdList);
		}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				defCount = AlmMongoOperations.getTotalDefectCountFilterQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
...
//						userId, domainName, projectName);
	...
	public List<DefectTrendVO> getDefecttrendchart(String authString, String dashboardName, String domainName,
			String projectName, String vardtfrom, String vardtto, String timeperiod) throws ParseException {
		...
		if (operationalAccess) {
			try {
				...
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				trendvolist = AlmMongoOperations.getDefecttrendchartQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getDefectbardashchartQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getDefectenvchartQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				result = AlmMongoOperations.getDefectuserchartQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				defAnalysisList = AlmMongoOperations.getRecordsdefQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, itemsPerPage, startIndex, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
		...
		if (operationalAccess) {
			try {
				/*List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
						projectName);*/
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				defCount = AlmMongoOperations.getTotalDefectCountinitialQuery(dashboardName, userId, domainName,
						projectName, startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
	...
	public int defectRejectionRate(String authString, String dashboardName, String domainName, String projectName) {
		...
		try {
			List<String> levelIdList = AlmMongoOperations.getGlobalLevelIdDefect(dashboardName, userId, domainName,
					projectName);
			defRejRate = AlmMongoOperations.defectRejectionRateQuery(dashboardName, userId, domainName, projectName,
					levelIdList);
		} catch (NumberFormatException | BaseException | BadLocationException e) {
			logger.error(e.getMessage());
		}
	...
	public List<DefectVO> getRecords(String authString, String dashboardName, String domainName, String projectName,
		...
		if (operationalAccess) {
			try {
				...
				List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(dashboardName, userId, domainName, projectName);
				srcFileAnalysisList = AlmMongoOperations.getRecordsQuery(dashboardName, userId, domainName, projectName,
						startDate, endDate, dateBefore7Days, dates, levelIdList);
			} catch (NumberFormatException | BaseException | BadLocationException e) {
				logger.error(e.getMessage());
			}
