...
public class AlmServices{
	...
	public long getRequirementCountFilter(@HeaderParam("Authorization") String authString,
		...
		totalReq = almMetrics.getRequirementCountFilter(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<ReqTrendVO> getRequirementTrendChart(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<ReqTrendVO> trendvoList = almMetrics.getRequirementTrendChart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirementStatusVO> getRequirementBarChart(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<RequirementStatusVO> dailyStatus = almMetrics.getRequirementBarChart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirementStatusVO> getRequirementPriorityChartFilter(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<RequirementStatusVO> priorityResult = almMetrics.getRequirementPriorityChartFilter(authString,
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirmentVO> getRecordsAlmRequirement(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<RequirmentVO> reqAnalysisList = almMetrics.getRequirementRecords(authString, itemsPerPage, start_index,
				dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public long getReqVolatilityFilter(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		long reqResult = almMetrics.getRequirementVolatilityFilter(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
	...
	public long getReqLeakFilter(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		long reqLeak = almMetrics.getRequirementLeakFilter(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirmentVO> getRecordsAnalyseLevel(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<RequirmentVO> reqAnalyzedataLevel = almMetrics.getRequirementRecordsAnalyseLevel(authString, dashboardName,
				domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	public long getReqCount(@HeaderParam("Authorization") String authString,
		...
		long totalreq = 0;
		almMetrics = new AlmMetrics();
		totalreq = almMetrics.getReqCount(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public long getSearchPageCount(@HeaderParam("Authorization") String authString, @QueryParam("reqID") int reqID,
			@QueryParam("releaseName") String releaseName, @QueryParam("reqName") String reqName,
			@QueryParam("description") String description, @QueryParam("reqType") String reqType,
			@QueryParam("status") String status, @QueryParam("priority") String priority,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		long pageCount = 0;
		almMetrics = new AlmMetrics();
		pageCount = almMetrics.getSearchPageCount(authString, releaseName, reqID, reqName, description, reqType, status,
				priority, dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirmentVO> getsearchreq(@HeaderParam("Authorization") String authString,
			@QueryParam("releaseName") String releaseName, @QueryParam("reqID") int reqID,
			@QueryParam("reqName") String reqName, @QueryParam("description") String description,
			@QueryParam("reqType") String reqType, @QueryParam("status") String status,
			@QueryParam("priority") String priority, @QueryParam("itemsPerPage") int itemsPerPage,
		...
		almMetrics = new AlmMetrics();
		searchResult = almMetrics.getRequirementSearchReq(authString, releaseName, reqID, reqName, description, reqType,
				status, priority, itemsPerPage, start_index, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<RequirmentVO> getRecords(@HeaderParam("Authorization") String authString,
		...
		reqAnalyzedata = almMetrics.getRecords(authString, sortvalue, itemsPerPage, start_index, reverse, dashboardName,
				domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	/**
	 * Requirement Passed Count - On Load Metric : Operational/ Requirement/Total
	 * Requirement Count Rest URL : rest/requirementServices/reqPassedCount JS File
	 * : WebContent\app\pages\charts
	 * \requirements\requirementsdata\RequirementsCtrl.js JS Function:
	...
	public long getTcCount(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		totalTcExeCount = almMetrics.getTcCount(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	public long getManualCount(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		totalmanualCount = almMetrics.getManualCount(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public long getAutoCount(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		totalautoCount = almMetrics.getAutoCount(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	public long getTcCoverage(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqResult = 0;
		reqResult = almMetrics.getTcCoverage(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	public long firstTimePass(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqresult = 0;
		reqresult = almMetrics.firstTimePass(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	public long FuncationalAutomation(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqresult = 0;
		reqresult = almMetrics.FuncationalAutomation(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public long RegressionAutomation(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqresult = 0;
		reqresult = almMetrics.RegressionAutomation(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public long UATAutomation(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqresult = 0;
		reqresult = almMetrics.UATAutomation(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
	...
	public long errorDiscovery1(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long reqResult = 0;
		reqResult = almMetrics.errorDiscovery1(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
		return reqResult;
	}
	...
	public List<TestExeStatusVO> getTcExeStatusbarchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExeStatusVO> result = almMetrics.getTcExeStatusbarchart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	public List<TCExecutionOwnerVO> getTcExeOwnerChart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TCExecutionOwnerVO> result = almMetrics.getTcExeOwnerChart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	public List<TestExeTrendVO> getTestExecutionTrendchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExeTrendVO> trendvolist = almMetrics.getTestExecutionTrendchart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	public List<TestExecutionVO> getExecRecords(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExecutionVO> executionAnalyzedata = almMetrics.getExecRecords(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	/*
	 * Metric : Operational/Execution/ Execution Details Rest URL :
	 * rest/testExecutionServices/tcexeTableDetails JS File :
	 * WebContent\app\pages\charts\testexecution\testexecutiondata\TestExecutionCtrl
	 * .js JS Function: TestExecutionCtrl/ $scope.tcexeTableData = function
	 * (start_index)
	 */
	@GET
	...
	public List<TestExecutionVO> getRecordsTcExe(@HeaderParam("Authorization") String authString,
			@QueryParam("itemsPerPage") int itemsPerPage, @QueryParam("start_index") int start_index,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExecutionVO> tcexetabledetails = almMetrics.getRecordsTcExe(authString, itemsPerPage, start_index,
				dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	/*
	 * Metric : Operational/Execution/Execution Details Rest URL :
	 * rest/testExecutionServices/testexeData JS File :
	 * WebContent\app\pages\charts\testexecution\testexecutiondata\TestExecutionCtrl
	 * .js JS Function: $scope.sortedtable =
	 * function(sortvalue,itemsPerPage,start_index,reverse)
	 */
	@GET
	@Path("/testexeData")
	@Produces(MediaType.APPLICATION_JSON)
	public List<TestExecutionVO> getExecutionRecords(@HeaderParam("Authorization") String authString,
			@QueryParam("sortvalue") String sortvalue, @QueryParam("itemsPerPage") int itemsPerPage,
			@QueryParam("start_index") int start_index, @QueryParam("reverse") boolean reverse,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExecutionVO> tcexeAnalyzedata = almMetrics.getExecutionRecords(authString, sortvalue, itemsPerPage,
				start_index, reverse, dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
	...
	public long getExecutionSearchPageCount(@HeaderParam("Authorization") String authString,
			@QueryParam("releaseName") String releaseName, @QueryParam("cycleName") String cycleName,
			@QueryParam("testID") int testID, @QueryParam("testName") String testName,
			@QueryParam("testType") String testType, @QueryParam("testRunID") int testRunID,
			@QueryParam("testTester") String testTester, @QueryParam("testExecutionStatus") String testExecutionStatus,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		almMetrics = new AlmMetrics();
		/*
		 * long pagecount=almMetrics.getExecutionSearchPageCount(authString, testID,
		 * testName, testDescription, testType, testTester, testExecutionStatus,
		 * dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
		 */

		long pagecount = almMetrics.getExecutionSearchPageCount(authString, releaseName, cycleName, testID, testName,
				testType, testRunID, testTester, testExecutionStatus, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public List<TestExecutionVO> getExecutionSearch(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<TestExecutionVO> searchresult = almMetrics.getExecutionSearch(authString, releaseName, cycleName, testID,
				testName, testType, testRunID, testTester, testExecutionStatus, itemsPerPage, start_index,
				dashboardName, domainName, projectName, vardtfrom, vardtto, timeperiod);
		return searchresult;
	 ...
	 * @Path("/executionData")
	 * 
	 * @Produces(MediaType.APPLICATION_JSON) public List<TestExecutionVO>
	 * getRecords(@HeaderParam("Authorization") String authString,
	 * 
	 ...
	 * authenticateresult=authenticateUser(authString); List<TestExecutionVO>
	 * executionAnalyzedata=null; if(authenticateresult) { List<String> levelIdList
	 * = AlmMongoOperations.getGlobalLevelIdExecution(dashboardName, owner,
	 * domainName, projectName); String query =
	 * "{},{_id: 0, testID: 1, testName: 1, testDescription: 1, testTester: 1, testType: 1, testExecutionStatus: 1, testExecutionDate: 1}"
	 * ;
	 * 
	 ...
	 * TestExecutionVO.class); return executionAnalyzedata; }else{ return
	 * executionAnalyzedata; } }
	 */
	/*
	 * **************************************************************************ALM
	 * Design Starts
	 ...
	 * rest/testCaseServices/totalTestCountFilter JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl / $scope.testCountFilter = function()
	 */
	...
	public long getTotalTestCountFilter(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long testCount = 0;
		testCount = almMetrics.getTotalTestCountFilter(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return testCount;
	}
	...
	/*
	 * Metric : Operational/Design/Test Design Coverage Rest URL :
	 * rest/testCaseServices/designCovFilter JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.designCoverageFilter=function()
	 */
	...
	public long getDesignCoverageFilter(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long designcovg = 0;
		designcovg = almMetrics.getDesignCoverageFilter(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return designcovg;
...
*/
	...
	public long getAutoCoverageFilter(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long acresult = 0;
		acresult = almMetrics.getAutoCoverageFilter(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return acresult;
	}
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<TestCaseVO> getRecordsLevel(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		executionAnalyzedataLevel = almMetrics.getRecordsLevel(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
	...
	/*
	 * Metric : Operational/Design/ Design Status Trend (Daily Status) Rest URL :
	 * rest/testCaseServices/tctrendchartdata JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.TCTrendChart=function(domain,
	 * project,release)
	 */
	@GET
	@Path("/tctrendchartdata")
	@Produces(MediaType.APPLICATION_JSON)
	public List<TestCaseTrendVO> getTestCaseTrendchart(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		trendvolist = almMetrics.getTestCaseTrendchart(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return trendvolist;
	}
	...
	/*
	 * Metric : Operational/Design/ Design Count by Status Rest URL :
	 * rest/testCaseServices/designstatuschartdata JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.newStatusChart=function(domain,
	 * project,release)
	 */
	@GET
	...
	public List<TestCaseStatusVO> getdesignstatus(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		result = almMetrics.getdesignstatus(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
		return result;
	}
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<TestCaseStatusVO> getdesigntype(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		almMetrics = new AlmMetrics();
		List<TestCaseStatusVO> result = null;
		result = almMetrics.getdesigntype(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
		return result;
	}
	...
	/*
	 * Metric : Operational/Design/ Design Count by Owner Rest URL :
	 * rest/testCaseServices/designownerchartdata JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.newOwnerCountChart=function(domain,
	 * project,release)
	 */
	@GET
	...
	public List<TestCaseStatusVO> getdesignowner(@HeaderParam("Authorization") String authString,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			throws JsonParseException, JsonMappingException, IOException, NumberFormatException, BaseException,
		...
		almMetrics = new AlmMetrics();
		List<TestCaseStatusVO> result = null;
		result = almMetrics.getdesignowner(authString, dashboardName, domainName, projectName, vardtfrom, vardtto,
				timeperiod);
		return result;
	}
	 ...
	 * rest/testCaseServices/tcTableDetails JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.tcTableData = function(start_index)
	 */
	@GET
	@Path("/tcTableDetails")
	@Produces(MediaType.APPLICATION_JSON)

	public List<TestCaseVO> getRecordstc(@HeaderParam("Authorization") String authString,
			@QueryParam("itemsPerPage") int itemsPerPage, @QueryParam("start_index") int start_index,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
		...
		reqAnalysisList = almMetrics.getRecordstc(authString, itemsPerPage, start_index, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
		return reqAnalysisList;
	}
	...
	public long getTotalTestCountinitial(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long testCount = 0;
		testCount = almMetrics.getTotalTestCountinitial(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return testCount;
	}
	...
	/*
	 * Metric : Operational/Design/Test Design Coverage Rest URL :
	 * rest/testCaseServices/designCoverage JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.designCoverage=function()
	 */
	@GET
	@Path("/designCoverage")
	@Produces(MediaType.APPLICATION_JSON)
	public long getDesignCoverage(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long designcovg = 0;
		designcovg = almMetrics.getDesignCoverage(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return designcovg;
	}
	...
	/*
	 * Metric : Operational/Design/Automation Coverage Rest URL :
	 * rest/testCaseServices/autoCoverageinitial JS File :
	 * WebContent\app\pages\charts\testcases\testcasesdata\TestCasesCtrl.js JS
	 * Function: TestCasesCtrl/ $scope.autoCoverage=function()
	 */
	@GET
	...
	public long getAutoCoverageinitial(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long acresult = 0;
		acresult = almMetrics.getAutoCoverageinitial(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
		return acresult;
	}
	...
	public int defectRejectionRateFilter(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		int defRejRate = almMetrics.defectRejectionRateFilter(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
		return defRejRate;
...
/* Defect Status Trend(Trend Graph) Starts Here */
	...
	public List<DefectTrendVO> getDefecttrendchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<DefectTrendVO> trendvolist = almMetrics.getDefecttrendchart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
		return trendvolist;
	...
	public List<DefectStatusVO> getDefectbardashchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<DefectStatusVO> result = almMetrics.getDefectbardashchart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
		return result;
	}
	...
	public List<DefectStatusVO> getDefectenvchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<DefectStatusVO> result = almMetrics.getDefectenvchart(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
		return result;
	}
	...
	/*
	 * Metric : Operational/Defect/Defects Assigned To Rest URL :
	 * rest/defectServices/defectownerchartdata JS File :
	 * WebContent\app\pages\charts\defects\defectsdata\defectsCtrl.js JS Function:
	 * $scope.newOwnerChart=function(domain, project,release)
	 */
	...
	public List<DefectStatusVO> getDefectuserchart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<DefectStatusVO> result = almMetrics.getDefectuserchart(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
		return result;
	}
	 ...
	 * rest/defectServices/defectTableDetails JS File :
	 * WebContent\app\pages\charts\defects\defectsdata\defectsCtrl.js JS Function:
	...
	@Produces(MediaType.APPLICATION_JSON)
	public List<DefectVO> getRecordsdef(@HeaderParam("Authorization") String authString,
			@QueryParam("itemsPerPage") int itemsPerPage, @QueryParam("start_index") int start_index,
			@QueryParam("dashboardName") String dashboardName, @QueryParam("domainName") String domainName,
			@QueryParam("projectName") String projectName, @QueryParam("vardtfrom") String vardtfrom,
			@QueryParam("vardtto") String vardtto, @QueryParam("timeperiod") String timeperiod)
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<DefectVO> defAnalysisList = almMetrics.getRecordsdef(authString, itemsPerPage, start_index, dashboardName,
				domainName, projectName, vardtfrom, vardtto, timeperiod);
	 ...
	 * rest/defectServices/totalDefectCountinitial JS File :
	 * WebContent\app\pages\charts\defects\defectsdata\defectsCtrl.js JS Function:
	 * defectsCtrl/ $scope.initialcount = function()
	 */
	...
	public long getTotalDefectCountinitial(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		long defCount = almMetrics.getTotalDefectCountinitial(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
		return defCount;
	}
	...
	/*
	 * Metric : Operational/Defect/Defect Rejection Rate Rest URL :
	 * rest/defectServices/defectRejectionRate JS File :
	 * WebContent\app\pages\charts\defects\defectsdata\defectsCtrl.js JS Function:
	 * defectsCtrl/ $scope.defectrejrate=function()
	 */
	...
	public List<DefectVO> getRecords(@HeaderParam("Authorization") String authString,
		...
		srcFileAnalysisList = almMetrics.getRecords(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public long getTcCountForTable(@HeaderParam("Authorization") String authString,
		...
		long totalTcExeCount = 0;
		almMetrics = new AlmMetrics();
		totalTcExeCount = almMetrics.getTcCountForTable(authString, dashboardName, domainName, projectName, vardtfrom,
				vardtto, timeperiod);
	...
	public long getRegressionAutomationFilter(@HeaderParam("Authorization") String authString,
		...
		almMetrics = new AlmMetrics();
		long acresult = 0;
		acresult = almMetrics.getRegressionAutomationFilter(authString, dashboardName, domainName, projectName,
				vardtfrom, vardtto, timeperiod);
		return acresult;
	}
	...
	public List<ExecutionFuncUtilVO> getFunctionalUtilChart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<ExecutionFuncUtilVO> result = almMetrics.getFunctionalUtilChart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
	...
	public List<ExecutionRegUtilVO> getRegressionUtilChart(@HeaderParam("Authorization") String authString,
			...
			BadLocationException, ParseException {
		almMetrics = new AlmMetrics();
		List<ExecutionRegUtilVO> result = almMetrics.getRegressionChart(authString, dashboardName, domainName,
				projectName, vardtfrom, vardtto, timeperiod);
