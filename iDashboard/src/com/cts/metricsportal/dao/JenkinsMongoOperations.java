// ***************************************************************************************************/
//  Code Modified on 16/4/2019 
//  Modified by : 586907 Shankar Mahadevan
// ***************************************************************************************************/
...
public class JenkinsMongoOperations extends BaseMongoOperation {
	...
	private static String ChangeDateformat(Date dtparam) throws ParseException {
		...
		String outparam = "";
		DateFormat datef = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy", Locale.ENGLISH);
	...
	public static List<BuildJobsVO> Jenkins_ExecuteQuery_GetBuildJobs() {
	...
	public static List<BuildTotalVO> Jenkins_ExecuteQuery_GetBuildPeryDay(String AppName) {
	...
	public static List<BuildListVO> Jenkins_ExecuteQuery_GetLatestBuild(String AppName) {
		List<BuildJobsVO> buildJobList = new ArrayList<BuildJobsVO>();
		List<BuildListVO> buildls = new ArrayList<BuildListVO>();
	...
	public static List<BuildTotalVO> Jenkins_ExecuteQuery_GetAverageBuildDuration(String AppName) {
