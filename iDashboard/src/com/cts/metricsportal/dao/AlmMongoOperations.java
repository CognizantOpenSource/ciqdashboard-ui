...
public class AlmMongoOperations extends BaseMongoOperation {
	...
	public static List<RequirementStatusVO> getRequirementTrendChart(Date startDate, Date endDate, Date dates, Date dateBefore7Days , List<String> levelIdList)
	{
		...
		try
		{
			if(startDate != null || endDate != null)
			{
				Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),match(Criteria.where("creationTime").gte(startDate).lte(endDate)), 
						group("creationTime").count().as("count"), project("count").and("creationTime").previousOperation(), 
			...
			{
				Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)), match(Criteria.where("creationTime").gte(dateBefore7Days).lte(dates)), 
					group("creationTime").count().as("count"), project("count").and("creationTime")
					.previousOperation(), sort(Direction.ASC, "creationTime"));
			...
			{
				Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)), group("creationTime").count()
					.as("count"), project("count").and("creationTime")
					.previousOperation(), sort(Direction.ASC, "creationTime"));
	...
	public static List<RequirementStatusVO> getRequirementTrendChartFinal(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList, RequirementStatusVO info)
	{
		...
		try
		{
			if(startDate != null || endDate != null)
			{
				Aggregation agg1 = newAggregation(match(Criteria.where("_id").in(levelIdList)), match(Criteria.where("creationTime").gte(startDate).lte(endDate)),
				...
				AggregationResults<RequirementStatusVO> groupResultsFinal = getMongoOperation().aggregate(agg1, RequirmentVO.class,RequirementStatusVO.class);
				result1 = groupResultsFinal.getMappedResults();
			}
			else
			{
				Aggregation agg1 = newAggregation(match(Criteria.where("_id").in(levelIdList)),match(Criteria.where("creationTime").is(info.getCreationTime())),
					group("status").count().as("statusCnt"),
					project("statusCnt").and("status").previousOperation());
				AggregationResults<RequirementStatusVO> groupResultsFinal = getMongoOperation().aggregate(agg1, RequirmentVO.class,RequirementStatusVO.class);
				result1 = groupResultsFinal.getMappedResults();
	...
	public static List<RequirementStatusVO> getRequirementBarChart(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
		...
		try {
			if(startDate != null || endDate != null)
			{
				...
				AggregationResults<RequirementStatusVO> groupResults = getMongoOperation().aggregate(agg, RequirmentVO.class,RequirementStatusVO.class);
			...
			{
				Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)), group("status").count().as("statusCnt"),
						project("statusCnt").and("status").previousOperation());
	...
	public static List<RequirementStatusVO> getRequirementPriorityChartFilter(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
		...
		try {
			...
			Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
					...
					sort(Direction.ASC, "priority"));
			AggregationResults<RequirementStatusVO> groupResults = getMongoOperation()
					.aggregate(agg, RequirmentVO.class,RequirementStatusVO.class);
				priorityresult = groupResults.getMappedResults();
			}
		}
		catch(NumberFormatException | BaseException| BadLocationException e) {
	...
	public static List<RequirmentVO> getRequirementRecords(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<Integer> levelIdList, int itemsPerPage, int start_index)
	{
	...
	public static long getRequirementVolatilityFilter(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
		...
		try {
			...
			query1 = new BasicQuery(new BasicDBObject("$where","this.creationTime.getTime() != this.lastModified.getTime()"));
			query1.addCriteria(Criteria.where("_id").in(levelIdList));
			if(startDate != null || endDate != null)
			{
				query1.addCriteria(Criteria.where("creationTime").gte(startDate).lte(endDate));
	...
	public static long getRequirementLeakFilter(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static List<RequirmentVO> getRequirementRecordsAnalyseLevel(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getReqCount(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getSearchPageCount(String releaseName,int reqID,String reqName,String description,String reqType,String status, String priority, Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
		long pageCount =0;
        ...
        for (Map.Entry<String, String> entry : searchvalues.entrySet()) {
        	 ...
        	 if (!entry.getValue().equals("undefined")) {
                 if (!entry.getValue().equals("null")) {
                        query1.addCriteria(Criteria.where(entry.getKey()).regex(
                                      entry.getValue(),"i"));
                 }
           }
    }
	...
	public static List<RequirmentVO> getRequirementSearchReq(int reqID, int itemsPerPage,int start_index, Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList, Map<String, String> searchvalues)
		{
	...
	public static List<RequirmentVO> getRecords(String sortvalue, boolean reverse, int itemsPerPage,int start_index, Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getTotalTestCountFilterQuery(String dashboardName, String userId, String domainName,
			String projectName, Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
	...
	public static List<TestCaseVO> getRecordsLevelQuery(String dashboardName, String userId, String domainName,
			String projectName, Date startDate, Date endDate, Date dateBefore7Days, Date dates, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
	...
	public static List<TestCaseTrendVO> getTestCaseTrendchartQuery(String dashboardName, String userId,
			String domainName, String projectName, Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
		...
		for (int i = 0; i < result.size(); i++) {
			...
			if(startDate != null && endDate != null)
			{
				...
				Aggregation agg1 = newAggregation(
					...
					match(Criteria.where("testCreationDate")
					.is(result.get(i).getTestCreationDate())),group("testDesignStatus").count()
					.as("statuscount"),project("statuscount").and("testDesignStatus")
					.previousOperation());

			AggregationResults<TestCaseStatusVO> groupResultsFinal = getMongoOperation().aggregate(agg1, TestCaseVO.class,
	...
	private static List<TestCaseStatusVO> getResultTestCaseStatus(List<String> levelIdList, Date startDate, Date endDate, Date dates,
			Date dateBefore7Days) throws NumberFormatException, BaseException, BadLocationException {
	...
	public static List<TestCaseStatusVO> getdesignstatusQuery(String dashboardName, String userId, String domainName,
			String projectName, Date startDate, Date endDate, Date dateBefore7Days, Date dates, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
		List<TestCaseStatusVO> result=null;
		logger.info("Fetching ALM Test case Design Status..");
	
		if(startDate != null && endDate != null)
		{
			Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
					match(Criteria.where("testCreationDate").gte(startDate).lte(endDate)),
					group("testDesignStatus").count().as("statuscount"),project("statuscount").and("testDesignStatus").previousOperation());
			AggregationResults<TestCaseStatusVO> groupResults
			= getMongoOperation().aggregate(agg, TestCaseVO.class, TestCaseStatusVO.class);
			result = groupResults.getMappedResults();
		}
		else if(dateBefore7Days != null && dates != null){
			Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
		...
		else
		{
			Aggregation agg = newAggregation(match(Criteria.where("_id")
					.in(levelIdList)),group("testDesignStatus").count().as("statuscount"),project("statuscount").and("testDesignStatus").previousOperation());
			AggregationResults<TestCaseStatusVO> groupResults
			= getMongoOperation().aggregate(agg, TestCaseVO.class, TestCaseStatusVO.class);
			result = groupResults.getMappedResults();
		}
	...
	public static List<TestCaseStatusVO> getdesigntypeQuery(String dashboardName, String userId, String domainName,
			String projectName, Date startDate, Date endDate, Date dateBefore7Days, Date dates, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
			List<TestCaseStatusVO> result=null;
			logger.info("Fetching ALM Test Case Design Type..");
			...
			{
				Aggregation agg = newAggregation(match(Criteria.where("_id")
						.in(levelIdList)),group("testType").count().as("typecount"),project("typecount").and("testType").previousOperation());
			 	AggregationResults<TestCaseStatusVO> groupResults
			 	= getMongoOperation().aggregate(agg, TestCaseVO.class, TestCaseStatusVO.class);
			 	result = groupResults.getMappedResults();
			}
	...
	public static List<TestCaseStatusVO> getdesignownerQuery(String dashboardName, String userId, String domainName,
		...
		if(startDate != null && endDate != null)
		{
 	 	Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
 	 			match(Criteria.where("testCreationDate").gte(startDate).lte(endDate)),
 	 			group("testDesigner").count().as("designercount"),project("designercount").and("testDesigner").previousOperation());
 	 	AggregationResults<TestCaseStatusVO> groupResults
 	 	= getMongoOperation().aggregate(agg, TestCaseVO.class, TestCaseStatusVO.class);
 	    result = groupResults.getMappedResults();
		}
	...
	public static long getManualCount(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getAutoCount(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getTcExec(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	public static long getTcPlan(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
	...
	/*
	 * public static long firstTimePass(Date startDate, Date endDate, Date dates,
	 * Date dateBefore7Days, List<Integer> levelIdList) {
	 * logger.info("Fetching First Time Pass Rate.."); long reqResult = 0; try {
	 * Query query = new Query(); String query1 =
	 * "{},{_id:0,levelId:1,defectID:1,status:1, testIteration:1}"; Query query2 =
	 * new BasicQuery(query1); if(startDate != null || endDate != null) {
	 * query2.addCriteria(Criteria.where("testExecutionDate").gte(startDate).lte(
	 * endDate)); } else if(dateBefore7Days != null && dates != null){
	 * query2.addCriteria(Criteria.where("testExecutionDate").gte(dateBefore7Days).
	 * lte(dates)); } query.addCriteria(Criteria.where("levelId").in(levelIdList));
	 * if(startDate != null || endDate != null) {
	 * query.addCriteria(Criteria.where("testExecutionDate").gte(startDate).lte(
	 * endDate)); } else if(dateBefore7Days != null && dates != null){
	 * query.addCriteria(Criteria.where("testExecutionDate").gte(dateBefore7Days).
	 * lte(dates)); } query = new Query(new
	 * Criteria().andOperator(Criteria.where("testExecutionStatus").is("Passed"),
	 * Criteria.where("testIteration").is("1"))); long passrate =
	 * getMongoOperation().count(query,TestExecutionVO.class); long
	 * tcsplannedtoexecute =
	 * getMongoOperation().count(query2,TestExecutionVO.class);
	 * 
	 * if(passrate>0 && tcsplannedtoexecute>0){ reqResult = passrate * 100 /
	 * tcsplannedtoexecute;} else { reqResult = 0; } return reqResult; } catch
	 * (NumberFormatException| BadLocationException e) {
...
//							((double) iRegressionAutomationTestsExecuted * 100) / ((double) iRegressionTestsExecuted));
	...
	public static long errorDiscovery1(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<Integer> levelIdList)
	{
		...
		long reqResult = 0;
		 ...
		 {	
			 Aggregation agg = newAggregation(match(Criteria.where("levelId").in(levelIdList)),
					...
					match(Criteria.where("testExecutionStatus").in(statuslist).andOperator(Criteria.where("defectId").ne("0"))),
					group("defectId").count().as("count"),
					project("count").and("defectId").previousOperation());
			 
			AggregationResults<TestExecutionVO> groupResults = getMongoOperation()
					.aggregate(agg, TestExecutionVO.class, TestExecutionVO.class);
			sevlist = groupResults.getMappedResults();
				...
				Aggregation agg = newAggregation(match(Criteria.where("levelId")
						.in(levelIdList)),
						match(Criteria.where("testExecutionStatus").in(statuslist).andOperator(Criteria.where("defectId").ne("0"))),
						group("defectId").count().as("count"),
						project("count").and("defectId").previousOperation());
	...
	public static List<TestExeStatusVO> getTcExeStatusbarchart(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	{
		...
		try {
			...
			{	Aggregation  agg = newAggregation(match(Criteria.where("_id")
					.in(levelIdList)),
					match(Criteria.where("testExecutionDate").gte(startDate).lte(endDate)),
					group("testExecutionStatus").count().as("statusCnt"),project("statusCnt").and("testExecutionStatus").previousOperation());
		 	 AggregationResults<TestExeStatusVO> groupResults = getMongoOperation().aggregate(agg, TestExecutionVO.class, TestExeStatusVO.class);
		 	 result = groupResults.getMappedResults();
			}
			else if(dateBefore7Days != null && dates != null){
				Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
	 ...
	 public static List<TCExecutionOwnerVO> getTcExeOwnerChart(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	 {
		 ...
		 try {
			 if(startDate != null || endDate != null)
				{	  Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
						match(Criteria.where("testExecutionDate").gte(startDate).lte(endDate)),
						group("testTester").count().as("statusCnt"),project("statusCnt").and("testTester").previousOperation());
				AggregationResults<TCExecutionOwnerVO> groupResults = getMongoOperation().aggregate(agg, TestExecutionVO.class, TCExecutionOwnerVO.class);
			 	 result = groupResults.getMappedResults();
				}
				else if(dateBefore7Days != null && dates != null){
					Aggregation agg = newAggregation(match(Criteria.where("_id").in(levelIdList)),
...
//												/ ((double) iRegressionTestsExecuted));
	 ...
	 public static List<TestExeStatusVO> getTestExecutionTrendchart(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<String> levelIdList)
	 {
	 ...
	 public static List<TestExeStatusVO> getTestExecutionTrendchartFinal(List<String> levelIdList, Date dateString)
	 {
		 List<TestExeStatusVO> result1 = new ArrayList<TestExeStatusVO>();
		 try {
				Aggregation agg1 = newAggregation(match(Criteria.where("_id").in(levelIdList)),match(Criteria.where("testExecutionDate").is(dateString)),
						group("testExecutionStatus").count().as("statuscount"),
						project("statuscount").and("testExecutionStatus").previousOperation());

				AggregationResults<TestExeStatusVO> groupResultsFinal = getMongoOperation().aggregate(agg1, TestExecutionVO.class,TestExeStatusVO.class);
	 ...
	 public static List<TestExecutionVO> getExecRecords(Date startDate, Date endDate, Date dates, Date dateBefore7Days, List<Integer> levelIdList)
	 {
	 ...
	 * String userId, String domainName, String projectName, Date startDate, Date
	 * endDate, Date dateBefore7Days, Date dates, List<String> levelIdList) throws
	...
	public static List<DefectTrendVO> getDefecttrendchartQuery(String dashboardName, String userId, String domainName,
		...
		for (int i = 0; i < result.size(); i++) {
			...
			Aggregation agg1 = newAggregation(
					match(Criteria.where("_id").in(levelIdList)),
					match(Criteria.where("opendate")
					.is(result.get(i).getOpendate())), group("status").count()
					.as("statuscount"), project("statuscount").and("status")
					.previousOperation());

			AggregationResults<DefectStatusVO> groupResultsFinal = getMongoOperation()
					.aggregate(agg1, DefectVO.class, DefectStatusVO.class);
			...
			for (int j = 0; j < result1.size(); j++) {
				...
				if (result1.get(j).getStatus().equalsIgnoreCase("Closed")) {
					...
					deftrendvo.setFixedDefects(fixedCnt);
				} else if (result1.get(j).getStatus()
				...
				else if (result1.get(j).getStatus().equalsIgnoreCase("Reopen")) {
					reopenCnt = result1.get(j).getStatuscount();
					deftrendvo.setReopenDefects(reopenCnt);
				}else if (result1.get(j).getStatus().equalsIgnoreCase("ReadyforQA")) {
					readyCnt = result1.get(j).getStatuscount();
			...
			for (DefectTrendVO chartVO : trendvolist) {
				...
				if (strDate.toString().equals((format.toString()))) {
					...
					chartVO.setReopenDefects(reopenCnt
							+ chartVO.getReopenDefects());
					chartVO.setReadyQA(readyCnt
							+ chartVO.getReadyQA());
					chartVO.setNostatus(nostatusCnt
							+ chartVO.getNostatus());
	...
	public static List<DefectStatusVO> getDefectbardashchartQuery(String dashboardName, String userId,
			String domainName, String projectName, Date startDate, Date endDate, Date dateBefore7Days, Date dates, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
	...
	public static List<DefectVO> getRecordsdefQuery(String dashboardName, String userId, String domainName,
			String projectName, Date startDate, Date endDate, Date dateBefore7Days, Date dates, int itemsPerPage, int start_index, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
		List<DefectVO> defAnalysisList=null;
		
			
		String query = "{},{_id:0,defectID:1,detectedBy:1,status:1,assignedBy:1,assignedTo:1,detectedPhase:1,priority:1,severity:1}";
	...
	public static int defectRejectionRateQuery(String dashboardName, String userId, String domainName,
			String projectName, List<String> levelIdList) throws NumberFormatException, BaseException, BadLocationException {
		int defRejRate = 0;
		logger.info("Fetching ALM Defect rejection rate..");
	...
	public static List<String> getGlobalLevelIdRequirement(String dashboardName,String owner, String domainName,String projectName) throws NumberFormatException,
		BaseException, BadLocationException
		{
		logger.info("Fetching Global LevelId ALM Requirement..");
		//fetch levelId store in list
		List<Integer> levelIdList = OperationalDAO.getGlobalLevelIds(
				dashboardName, owner, domainName, projectName);
	...
	public static List<String> getGlobalLevelIdDefect(String dashboardName,String owner, String domainName,String projectName) throws NumberFormatException, BaseException, BadLocationException
	{
		...
		reqList = getMongoOperation().aggregate(agg, "ALMDefects",
	...
	public static List<String> getGlobalLevelIdDesign(String dashboardName,String owner, String domainName,String projectName) throws NumberFormatException, BaseException, BadLocationException
	{
	...
	public static List<String> getGlobalLevelIdExecution(String dashboardName,String owner, String domainName,String projectName) throws NumberFormatException, BaseException, BadLocationException
	{
		...
		reqList = getMongoOperation().aggregate(agg, "ALMTestExecution",
