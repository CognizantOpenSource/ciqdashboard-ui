...
const routes: Routes = [
  ...
  // App views
  // Main redirect
  { path: '', redirectTo: 'idashboard', pathMatch: 'full', canActivate: [AuthGuard] },
  { path: 'home', redirectTo: 'idashboard', pathMatch: 'full', canActivate: [AuthGuard] },
  { path: 'idashboard', loadChildren: './modules/idashboard/idashboard.module#IDashBoardModule', canActivate: [AuthGuard], },
