...
(function () {
  ...
  angular.module('MetricsPortal.LifeCycle')
      .controller('chefMetricsCtrl', chefMetricsCtrl).filter('trimDesc',
  			function() {
  ...
  /** @ngInject */
 function chefMetricsCtrl($sessionStorage, paginationService, AES, $element, $scope, $state, $base64, $http, $timeout, $uibModal,
