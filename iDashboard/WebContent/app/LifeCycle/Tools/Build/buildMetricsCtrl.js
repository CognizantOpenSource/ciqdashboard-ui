...
(function() {
	...
	function buildMetricsCtrl($scope, AES, $state, buildData, baConfig, $element,
		...
		$scope.getlatestbuild = function(jobName) {
			...
			$http
					.get(
							"rest/buildcontroller/getlatestbuilds?AppName="
		...
		$scope.gettotalbuild = function(jobName) {
			...
			$http.get(
					"rest/buildcontroller/gettotalbuilds?AppName=" + jobName,
		...
		$scope.getavaragebuildduration = function(jobName) {
			...
			$http.get(
					"rest/buildcontroller/getaveragedurationbuild?AppName="
		...
		$scope.getbuildperday = function(jobName) {
			...
			$http.get(
					"rest/buildcontroller/getbuildperday?AppName=" + jobName,
					config).success(function(response) {
