...
(function() {
	...
	function LifeCycleDashboardCtrl($sessionStorage, AES, localStorageService,
					...
					.success(
							function(response) {
								if (response == 0) {
									$scope
											.open(
													'app/LifeCycle/saveDashboardMsg.html',
													'sm');
								} else {
									$scope
											.open(
													'app/LifeCycle/existDashboardMsg.html',
													'sm');
								}
							});
			setTimeout(function() {
					...
					.success(
							function(response) {
								...
								if (response == 0) {
									...
									$scope
											.open(
													'app/LifeCycle/updatedDashboardMsg.html',
													'sm');
								} else {
		...
		$scope.deleteDashboard = function(dashid) {
			...
			$uibModal.open({
				animation : true,
				templateUrl : 'app/LifeCycle/ProductDashboard/deleteDashboard.html',
				scope : $scope,
				size : 'sm',
				resolve : {
					items : function() {
		...
		$scope.deleteDashboardInfo = function(item) {
			...
			$http.get(
					...
					function(response) {
						...
						/*	   if(response==0){
								    $scope.$dismiss();
								    $scope.open('app/LifeCycle/deletedDashboardMsg.html','sm');
							   }
						 */
		...
		$scope.deleteRelDashboard = function(dashid) {
			...
			$uibModal
					.open({
						animation : true,
						templateUrl : 'app/LifeCycle/ReleaseDashboard/deleteRelDashboard.html',
						scope : $scope,
						size : 'sm',
						resolve : {
							items : function() {
		...
		$scope.deleteKpiDashboard = function(dashid) {
			...
			$uibModal
					.open({
						animation : true,
						templateUrl : 'app/LifeCycle/KpiDashboard/deleteKpiDashboard.html',
						scope : $scope,
						size : 'sm',
						resolve : {
							items : function() {
								...
								for (var i = 0; i < $scope.selectedLCTools.length; i++) {
									if ($scope.selectedLCTools[i].key == "codeQuality") {
										$scope.selectedKeyLists
												.push({
													"title" : "Code Quality",
													"path" : "app\\LifeCycle\\Tools\\CodeQuality\\codeQualityHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "chef") {
										$scope.selectedKeyLists
												.push({
													"title" : "Chef",
													"path" : "app\\LifeCycle\\Tools\\Infra\\chefMetricsHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "build") {
										$scope.selectedKeyLists
												.push({
													"title" : "Build",
													"path" : "app\\LifeCycle\\Tools\\Build\\buildMetricsHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "gitHub") {
										$scope.selectedKeyLists
												.push({
													"title" : "Github",
													"path" : "app\\LifeCycle\\Tools\\SCM\\GitHubHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "testManagement") {
										$scope.selectedKeyLists
												.push({
													...
													"path" : "app\\LifeCycle\\Tools\\TestManagement\\testManagementHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "userStory") {
										$scope.selectedKeyLists
												.push({
													...
													"path" : "app\\LifeCycle\\Tools\\AppLifeCycle\\Jira\\jiraHome.html"
												});
									}
									if ($scope.selectedLCTools[i].key == "fortify") {
										$scope.selectedKeyLists
												.push({
													"title" : "Fortify",
													"path" : "app\\LifeCycle\\Tools\\SAST\\fortifyHome.html"	
												});
									}
									if ($scope.selectedLCTools[i].key == "octane") {
										$scope.selectedKeyLists
												.push({
													"title" : "ALM Octane",
													"path" : "app\\LifeCycle\\Tools\\AppLifeCycle\\Octane\\OctaneHome.html"
												});
									}
