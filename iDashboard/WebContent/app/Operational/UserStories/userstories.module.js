...
//  angular.module('MetricsPortal.pages.charts.requirements', ['chart.js'])
//      .config(routeConfig).config(chartJsConfig);
  
angular.module('MetricsPortal.Operational.UserStories', ['chart.js'])
.config(routeConfig).config(chartJsConfig);

  /** @ngInject */
  function routeConfig($stateProvider) {
    $stateProvider
        .state('charts.userstories', {
          url: '/userstories',
          templateUrl: 'app/Operational/UserStorie/userstoriesMain.html',
          title: 'User Story',
          /*sidebarMeta: {
            order: 0,
          }, */ 
