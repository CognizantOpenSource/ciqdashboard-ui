...
(function() {
	...
	angular.module('MetricsPortal.Operational',
			[ 'ui.router', 'MetricsPortal.Operational' ]).config(routeConfig);
	...
	function routeConfig($urlRouterProvider, baSidebarServiceProvider,
		...
		$stateProvider
				.state('Operational', {
					url : '/Operational',
					directive : 'baSidebar',
					templateUrl : 'app/Operational/Home/operational.html',
					title : 'Dashboard',
				})
		 ...
		 * .state('viewDashbaordOperational', { url:
		 * '/viewDashbaordOperational', directive:'baSidebar', templateUrl:
		 * 'app/pages/operational/viewOperationalDashboard.html',
		 * 
		 * title:'Dashboard',
		 * 
		 * sidebarMeta: { icon: 'ion-ionic', order: 0, }, }) .state('dashboard', {
		 * url: '/dashboard', directive:'baSidebar', templateUrl:
		 * 'app/pages/dashboard/dashboard.html', title: 'Dashboard',
		 * 
