...
(function () {
  ...
  angular.module('MetricsPortal.ReportData', [
    'ui.router'])
      .config(routeConfig);
  ...
  function routeConfig($urlRouterProvider, baSidebarServiceProvider,$stateProvider,$routeProvider) { 
      ...
      .state('internalreport', {
          url: '/internalreport',
          directive:'baSidebar',
          templateUrl: 'app/CustomMetrics/ReportData/internalReport.html',
          title: 'Internal Report',
          resolve : {
				loadMyCtrl : [ '$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load({
						files : [ 'app/CustomMetrics/ReportData/reportDataCtrl.js' ],
					});
				} ]
			}
        })
      ...
      .state('reportdata', {
        url: '/reportdata',
        directive:'baSidebar',
        templateUrl: 'app/CustomMetrics/ReportData/reportData.html',
      ...
      .state('activitychart', {
        ...
        .state('capabilityreportchart', {
         ...
         .state('coEChartView', {
          url: '/coEChartView',
          directive:'baSidebar',
          templateUrl: 'app/CustomMetrics/ReportData/coEChartView.html',
          controller:'reportDataCtrl',
