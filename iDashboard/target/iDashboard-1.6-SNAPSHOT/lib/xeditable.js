...
angular.module('xeditable').directive('editableSelect', ['editableDirectiveFactory',
  function(editableDirectiveFactory) {
    return editableDirectiveFactory({
      ...
      inputTpl: '<select id="getvalrole" style="outline: 0; background-color: rgba(87, 95, 118, 1)" class="form-control" ><option value="" disabled>Select Role</option></select>',
      render: function() {
        this.parent.render.call(this);
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" ng-click="getRoleChange(details)" class="btn btn-primary btn-with-icon"> <i class="ion-checkmark-round"> </i></button>',
